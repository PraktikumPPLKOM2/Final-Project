...
#    Nov 30, 2020 08:30:52 AM +07  platform: Windows NT
...
import Student - My Profile_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    top = student_myprofile (root)
    Student - My Profile_support.init(root, top)
    root.mainloop()

w = None
def create_student_myprofile(rt, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_student_myprofile(root, *args, **kwargs)' .'''
    global w, w_win, root
    #rt = root
    root = rt
    w = tk.Toplevel (root)
    top = student_myprofile (w)
    Student - My Profile_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_student_myprofile():
    global w
    w.destroy()
    w = None

class student_myprofile:
    def __init__(self, top=None):
        ...
        top.geometry("600x500+654+111")
        top.minsize(120, 1)
        top.maxsize(1370, 729)
        top.resizable(1,  1)
        top.title("Student - My Profile")
        ...
        self.main_profile.place(relx=0.017, rely=0.076, relheight=0.904
                , relwidth=0.967)
        ...
        self.get_name.place(relx=0.198, rely=0.084, relheight=0.128
        ...
        self.entry_name.place(relx=0.029, rely=0.362, height=30, relwidth=0.943
                , bordermode='ignore')
        ...
        self.get_username.place(relx=0.198, rely=0.212, relheight=0.128
                , relwidth=0.603, bordermode='ignore')
        ...
        self.entry_username.place(relx=0.029, rely=0.328, height=30
        ...
        self.get_email.place(relx=0.198, rely=0.341, relheight=0.128
                , relwidth=0.603, bordermode='ignore')
        ...
        self.entry_email.place(relx=0.029, rely=0.328, height=30, relwidth=0.943
                , bordermode='ignore')
        ...
        self.get_phone_number.place(relx=0.198, rely=0.469, relheight=0.126
                , relwidth=0.603, bordermode='ignore')
        ...
        self.get_address.place(relx=0.198, rely=0.595, relheight=0.235
                , relwidth=0.603, bordermode='ignore')
        ...
        self.entry_address.place(relx=0.029, rely=0.17, height=80, relwidth=0.943
                , bordermode='ignore')

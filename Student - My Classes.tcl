...
#  Nov 30, 2020 08:32:01 AM +07  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 600x400+654+111
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    wm title $top "Student - My Classes"
    vTcl:DefineAlias "$top" "student_myclasses" vTcl:Toplevel:WidgetProc "" 1
    set vTcl(real_top) {}
    vTcl:withBusyCursor {
    menu $top.m45 \
    ...
    frame $top.fra49 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 605 
    vTcl:DefineAlias "$top.fra49" "navbar" vTcl:WidgetProc "student_myclasses" 1
    ...
    vTcl:DefineAlias "$site_3_0.but51" "logout_butt" vTcl:WidgetProc "student_myclasses" 1
    ...
    vTcl:DefineAlias "$site_3_0.lab55" "app_name" vTcl:WidgetProc "student_myclasses" 1
    ...
    vTcl:DefineAlias "$top.lab57" "main_classes" vTcl:WidgetProc "student_myclasses" 1
    ...
    vTcl:DefineAlias "$site_3_0.but63" "back_butt" vTcl:WidgetProc "student_myclasses" 1
    vTcl::widgets::ttk::scrolledlistbox::CreateCmd $site_3_0.scr71 \
        -background $vTcl(actual_gui_bg) -height 75 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 125 
    vTcl:DefineAlias "$site_3_0.scr71" "box_class" vTcl:WidgetProc "student_myclasses" 1
    ...
    vTcl:DefineAlias "$site_3_0.fra73" "class_detail" vTcl:WidgetProc "student_myclasses" 1
    ...
    labelframe $site_4_0.lab75 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 330 
    vTcl:DefineAlias "$site_4_0.lab75" "class_name" vTcl:WidgetProc "student_myclasses" 1
    ...
    vTcl:DefineAlias "$site_5_0.tex80" "get_class_name" vTcl:WidgetProc "student_myclasses" 1
    ...
    labelframe $site_4_0.lab76 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 330 
    vTcl:DefineAlias "$site_4_0.lab76" "teacher" vTcl:WidgetProc "student_myclasses" 1
    ...
    vTcl:DefineAlias "$site_5_0.tex81" "get_teacher_name" vTcl:WidgetProc "student_myclasses" 1
    place $site_5_0.tex81 \
        -in $site_5_0 -x 0 -relx 0.03 -y 0 -rely 0.333 -width 0 \
        -relwidth 0.939 -height 0 -relheight 0.5 -anchor nw \
        -bordermode ignore 
    labelframe $site_4_0.lab77 \
        -font TkDefaultFont -foreground black -text {Number of Members} \
        -background $vTcl(actual_gui_bg) -height 60 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 330 
    vTcl:DefineAlias "$site_4_0.lab77" "num_of_members" vTcl:WidgetProc "student_myclasses" 1
    ...
    vTcl:DefineAlias "$site_5_0.tex82" "get_num_of_members" vTcl:WidgetProc "student_myclasses" 1
    ...
    labelframe $site_4_0.lab84 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 330 
    vTcl:DefineAlias "$site_4_0.lab84" "num_of_assignments" vTcl:WidgetProc "student_myclasses" 1
    ...
    vTcl:DefineAlias "$site_5_0.tex85" "Text1" vTcl:WidgetProc "student_myclasses" 1
    place $site_5_0.tex85 \
        -in $site_5_0 -x 0 -relx 0.03 -y 0 -rely 0.333 -width 0 \
        -relwidth 0.939 -height 0 -relheight 0.5 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab75 \
        -in $site_4_0 -x 0 -relx 0.029 -y 0 -rely 0.038 -width 0 \
        -relwidth 0.943 -height 0 -relheight 0.226 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab76 \
        -in $site_4_0 -x 0 -relx 0.029 -y 0 -rely 0.264 -width 0 \
        -relwidth 0.943 -height 0 -relheight 0.226 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab77 \
        -in $site_4_0 -x 0 -relx 0.029 -y 0 -rely 0.491 -width 0 \
        -relwidth 0.943 -height 0 -relheight 0.223 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab84 \
        -in $site_4_0 -x 0 -relx 0.029 -y 0 -rely 0.717 -width 0 \
        -relwidth 0.943 -height 0 -relheight 0.226 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but63 \
        -in $site_3_0 -x 0 -relx 0.45 -y 0 -rely 0.868 -width 60 -relwidth 0 \

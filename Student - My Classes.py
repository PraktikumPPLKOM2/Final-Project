...
#    Nov 30, 2020 08:32:04 AM +07  platform: Windows NT
...
import Student - My Classes_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    Student - My Classes_support.set_Tk_var()
    top = student_myclasses (root)
    Student - My Classes_support.init(root, top)
    root.mainloop()

w = None
def create_student_myclasses(rt, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_student_myclasses(root, *args, **kwargs)' .'''
    global w, w_win, root
    #rt = root
    root = rt
    w = tk.Toplevel (root)
    Student - My Classes_support.set_Tk_var()
    top = student_myclasses (w)
    Student - My Classes_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_student_myclasses():
    global w
    w.destroy()
    w = None

class student_myclasses:
    def __init__(self, top=None):
        ...
        top.geometry("600x400+654+111")
        top.minsize(120, 1)
        top.maxsize(1370, 729)
        top.resizable(1,  1)
        top.title("Student - My Classes")
        ...
        self.navbar.place(relx=0.0, rely=0.0, relheight=0.07, relwidth=1.0)
        ...
        self.app_name.place(relx=0.0, rely=0.0, height=28, width=120)
        ...
        self.main_classes.place(relx=0.017, rely=0.095, relheight=0.88
                , relwidth=0.967)
        ...
        self.back_butt.place(relx=0.45, rely=0.869, height=30, width=60
                , bordermode='ignore')
        ...
        self.box_class.place(relx=0.033, rely=0.08, relheight=0.736
        ...
        self.box_class.configure(listvariable=Student - My Classes_support.class_n)

        self.class_detail = tk.Frame(self.main_classes)
        self.class_detail.place(relx=0.383, rely=0.08, relheight=0.736
        ...
        self.class_name.place(relx=0.03, rely=0.039, relheight=0.224
                , relwidth=0.944)
        ...
        self.get_class_name.place(relx=0.031, rely=0.328, relheight=0.5
        ...
        self.teacher.place(relx=0.03, rely=0.263, relheight=0.228
                , relwidth=0.944)
        ...
        self.get_teacher_name.place(relx=0.031, rely=0.339, relheight=0.492
                , relwidth=0.937, bordermode='ignore')
        ...
        self.num_of_members = tk.LabelFrame(self.class_detail)
        self.num_of_members.place(relx=0.03, rely=0.49, relheight=0.224
                , relwidth=0.944)
        self.num_of_members.configure(relief='groove')
        self.num_of_members.configure(foreground="black")
        self.num_of_members.configure(text='''Number of Members''')
        self.num_of_members.configure(background="#ffffff")
        self.num_of_members.configure(highlightbackground="#ffffff")
        self.num_of_members.configure(highlightcolor="black")

        self.get_num_of_members = tk.Text(self.num_of_members)
        self.get_num_of_members.place(relx=0.031, rely=0.328, relheight=0.5
                , relwidth=0.937, bordermode='ignore')
        self.get_num_of_members.configure(background="white")
        self.get_num_of_members.configure(font="TkTextFont")
        self.get_num_of_members.configure(foreground="black")
        self.get_num_of_members.configure(highlightbackground="#ffffff")
        self.get_num_of_members.configure(highlightcolor="black")
        self.get_num_of_members.configure(insertbackground="black")
        self.get_num_of_members.configure(selectbackground="blue")
        self.get_num_of_members.configure(selectforeground="white")
        self.get_num_of_members.configure(wrap="word")

        self.num_of_assignments = tk.LabelFrame(self.class_detail)
        self.num_of_assignments.place(relx=0.03, rely=0.718, relheight=0.224
                , relwidth=0.944)
        ...
        self.Text1 = tk.Text(self.num_of_assignments)
        self.Text1.place(relx=0.031, rely=0.328, relheight=0.5, relwidth=0.937
                , bordermode='ignore')

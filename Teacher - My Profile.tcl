...
#  Dec 01, 2020 09:46:31 AM +07  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm deiconify $top
    wm title $top "Teacher - My Profile"
    ...
    frame $top.fra49 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 605 
    vTcl:DefineAlias "$top.fra49" "navbar" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_3_0.but51" "logout_butt" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_3_0.lab55" "app_name" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$top.lab57" "main_profile" vTcl:WidgetProc "Toplevel1" 1
    ...
    labelframe $site_3_0.lab58 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 150 
    vTcl:DefineAlias "$site_3_0.lab58" "get_name" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_4_0.ent64" "entry_name" vTcl:WidgetProc "Toplevel1" 1
    ...
    labelframe $site_3_0.lab59 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 360 
    vTcl:DefineAlias "$site_3_0.lab59" "get_username" vTcl:WidgetProc "Toplevel1" 1
    ...
    entry $site_4_0.ent65 \
        ...
        -insertbackground black -selectbackground blue \
        -selectforeground white -width 330 
    vTcl:DefineAlias "$site_4_0.ent65" "entry_username" vTcl:WidgetProc "Toplevel1" 1
    ...
    labelframe $site_3_0.lab60 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 360 
    vTcl:DefineAlias "$site_3_0.lab60" "get_email" vTcl:WidgetProc "Toplevel1" 1
    ...
    entry $site_4_0.ent66 \
        ...
        -insertbackground black -selectbackground blue \
        -selectforeground white -width 330 
    vTcl:DefineAlias "$site_4_0.ent66" "entry_email" vTcl:WidgetProc "Toplevel1" 1
    ...
    labelframe $site_3_0.lab61 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 360 
    vTcl:DefineAlias "$site_3_0.lab61" "get_phone_number" vTcl:WidgetProc "Toplevel1" 1
    ...
    entry $site_4_0.ent67 \
        ...
        -insertbackground black -selectbackground blue \
        -selectforeground white -width 330 
    vTcl:DefineAlias "$site_4_0.ent67" "entry_phone_number" vTcl:WidgetProc "Toplevel1" 1
    ...
    labelframe $site_3_0.lab62 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 360 
    vTcl:DefineAlias "$site_3_0.lab62" "get_address" vTcl:WidgetProc "Toplevel1" 1
    ...
    entry $site_4_0.ent68 \
        ...
        -insertbackground black -selectbackground blue \
        -selectforeground white -width 330 
    vTcl:DefineAlias "$site_4_0.ent68" "entry_address" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_3_0.but63" "back_butt" vTcl:WidgetProc "Toplevel1" 1
